...
$cliente = $model_polizas->agregar_beneficiario($nombre, $fecha_nacimiento, $calle, $numero, $colonia, $ciudad, $codigo_postal, $estado, $telefono, $telefono_alternativo, $curp, $fecha_registro);
